...
const client = algoliasearch("JIMBGKZ8LO", "f050ba62d4f7458801bbfb4c7b315ad8"); /*use your own keys*/
const index = client.initIndex('chatapp');

admin.initializeApp({
  credential: admin.credential.cert(serviceAccount),
  databaseURL: "https://chatapp-1178f-default-rtdb.firebaseio.com"
});
